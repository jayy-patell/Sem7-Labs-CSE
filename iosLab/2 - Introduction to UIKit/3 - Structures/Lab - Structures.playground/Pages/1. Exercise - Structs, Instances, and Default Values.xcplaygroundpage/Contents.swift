...
var somePlace = GPS(longitude: 12, latitude: 9)
...
favoriteBook.title="Hello"
favoriteBook.author="World"
favoriteBook.pages = 120
favoriteBook.price = 99.99
print(favoriteBook.title, favoriteBook.price)
/*:
