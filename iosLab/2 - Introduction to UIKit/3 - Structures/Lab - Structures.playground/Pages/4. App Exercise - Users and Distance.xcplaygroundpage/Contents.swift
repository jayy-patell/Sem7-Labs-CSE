...
var Jay = User(name: "Jay", age: 21, height: 175, weight: 75, activityLevel: 2)
print(Jay.name, Jay.age, Jay.height, Jay.weight, Jay.activityLevel)
/*:
