...
// The value of userAge is nil because the String "34e" contains non-numeric characters.
// The Int initializer returns nil when it cannot convert the input String into a valid integer.
...
if let unwrappedUserAge = userAge {
    print("User age is \(unwrappedUserAge)")
} else {
