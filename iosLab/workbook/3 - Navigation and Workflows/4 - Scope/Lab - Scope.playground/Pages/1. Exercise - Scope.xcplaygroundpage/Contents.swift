...
print("because it is a local variable")
...
print("one is in local scope of foo and other x is in global scope")
...
greeting(greeting: "Hello", name: "Sara")
greeting(greeting: nil, name:"Hari9")
